    ...
    public static class NexusGeneratedBinder
    {
        ...
        public static void PreserveMembers()
        {
            ...
            if (false)
            {
                ...
                var _p_ResourceLocalizationTableProvider_Logger = default(Nexus.Core.Services.ResourceLocalizationTableProvider).Logger;
                _ = _p_ResourceLocalizationTableProvider_Logger; // Suppress CS0219 warning
                var _p_BloomFlashMediator_SignalBus = default(PixelFlow.Views.BloomFlashMediator).SignalBus;
                _ = _p_BloomFlashMediator_SignalBus; // Suppress CS0219 warning
                ...
                var _p_CellView_Config = default(PixelFlow.Views.CellView).Config;
                _ = _p_CellView_Config; // Suppress CS0219 warning
                var _p_ConfettiMediator_SignalBus = default(PixelFlow.Views.ConfettiMediator).SignalBus;
                _ = _p_ConfettiMediator_SignalBus; // Suppress CS0219 warning
                ...
                var _p_DailyCrisisMediator_SignalBus = default(PixelFlow.Views.DailyCrisisMediator).SignalBus;
                _ = _p_DailyCrisisMediator_SignalBus; // Suppress CS0219 warning
                var _p_DailyCrisisView_LocalizationService = default(PixelFlow.Views.DailyCrisisView).LocalizationService;
                _ = _p_DailyCrisisView_LocalizationService; // Suppress CS0219 warning
                ...
                var _p_GarageMediator_SkinCatalog = default(PixelFlow.Views.GarageMediator).SkinCatalog;
                _ = _p_GarageMediator_SkinCatalog; // Suppress CS0219 warning
                var _p_GarageMediator_LocalizationService = default(PixelFlow.Views.GarageMediator).LocalizationService;
                _ = _p_GarageMediator_LocalizationService; // Suppress CS0219 warning
                ...
                var _p_GridMediator_SignalBus = default(PixelFlow.Views.GridMediator).SignalBus;
                _ = _p_GridMediator_SignalBus; // Suppress CS0219 warning
                ...
                var _p_GridView_InputService = default(PixelFlow.Views.GridView).InputService;
                _ = _p_GridView_InputService; // Suppress CS0219 warning
                ...
                var _p_HUDMediator_SignalBus = default(PixelFlow.Views.HUDMediator).SignalBus;
                _ = _p_HUDMediator_SignalBus; // Suppress CS0219 warning
                ...
                var _p_HUDView_ThemePalette = default(PixelFlow.Views.HUDView).ThemePalette;
                _ = _p_HUDView_ThemePalette; // Suppress CS0219 warning
                var _p_HUDView_SettingsModel = default(PixelFlow.Views.HUDView).SettingsModel;
                _ = _p_HUDView_SettingsModel; // Suppress CS0219 warning
                var _p_HUDView_GameConfig = default(PixelFlow.Views.HUDView).GameConfig;
                _ = _p_HUDView_GameConfig; // Suppress CS0219 warning
                var _p_LevelSelectMediator_GameStateModel = default(PixelFlow.Views.LevelSelectMediator).GameStateModel;
                _ = _p_LevelSelectMediator_GameStateModel; // Suppress CS0219 warning
                var _p_LevelSelectMediator_ProgressModel = default(PixelFlow.Views.LevelSelectMediator).ProgressModel;
                _ = _p_LevelSelectMediator_ProgressModel; // Suppress CS0219 warning
                var _p_LevelSelectMediator_ProgressionService = default(PixelFlow.Views.LevelSelectMediator).ProgressionService;
                _ = _p_LevelSelectMediator_ProgressionService; // Suppress CS0219 warning
                var _p_LevelSelectMediator_LoggerService = default(PixelFlow.Views.LevelSelectMediator).LoggerService;
                _ = _p_LevelSelectMediator_LoggerService; // Suppress CS0219 warning
                var _p_LevelSelectMediator_Config = default(PixelFlow.Views.LevelSelectMediator).Config;
                _ = _p_LevelSelectMediator_Config; // Suppress CS0219 warning
                var _p_LevelSelectMediator_LocalizationService = default(PixelFlow.Views.LevelSelectMediator).LocalizationService;
                _ = _p_LevelSelectMediator_LocalizationService; // Suppress CS0219 warning
                var _p_LevelSelectMediator_SignalBus = default(PixelFlow.Views.LevelSelectMediator).SignalBus;
                _ = _p_LevelSelectMediator_SignalBus; // Suppress CS0219 warning
                var _p_LevelSelectView_LoggerService = default(PixelFlow.Views.LevelSelectView).LoggerService;
                _ = _p_LevelSelectView_LoggerService; // Suppress CS0219 warning
                ...
                var _p_MainMenuMediator_LocalizationService = default(PixelFlow.Views.MainMenuMediator).LocalizationService;
                _ = _p_MainMenuMediator_LocalizationService; // Suppress CS0219 warning
                ...
                var _p_MainMenuMediator_GridStateSerializer = default(PixelFlow.Views.MainMenuMediator).GridStateSerializer;
                _ = _p_MainMenuMediator_GridStateSerializer; // Suppress CS0219 warning
                ...
                var _p_SettingsMediator_LocalizationService = default(PixelFlow.Views.SettingsMediator).LocalizationService;
                _ = _p_SettingsMediator_LocalizationService; // Suppress CS0219 warning
                var _p_SettingsMediator_SignalBus = default(PixelFlow.Views.SettingsMediator).SignalBus;
                _ = _p_SettingsMediator_SignalBus; // Suppress CS0219 warning
                ...
                var _p_SoundHandlerMediator_SignalBus = default(PixelFlow.Views.SoundHandlerMediator).SignalBus;
                _ = _p_SoundHandlerMediator_SignalBus; // Suppress CS0219 warning
                ...
                var _p_SplashMediator_SignalBus = default(PixelFlow.Views.SplashMediator).SignalBus;
                ...
                var _p_StarPassView_LocalizationService = default(PixelFlow.Views.StarPassView).LocalizationService;
                _ = _p_StarPassView_LocalizationService; // Suppress CS0219 warning
                ...
                var _p_ThemeHandlerMediator_SignalBus = default(PixelFlow.Views.ThemeHandlerMediator).SignalBus;
                _ = _p_ThemeHandlerMediator_SignalBus; // Suppress CS0219 warning
                var _p_TutorialView_LocalizationService = default(PixelFlow.Views.TutorialView).LocalizationService;
                _ = _p_TutorialView_LocalizationService; // Suppress CS0219 warning
                ...
                var _p_TutorialMediator_SignalBus = default(PixelFlow.Views.TutorialMediator).SignalBus;
                _ = _p_TutorialMediator_SignalBus; // Suppress CS0219 warning
                ...
                var _p_AdManagerService_EconomyService = default(PixelFlow.Services.AdManagerService).EconomyService;
                _ = _p_AdManagerService_EconomyService; // Suppress CS0219 warning
                ...
                var _p_AdManagerService_Keys = default(PixelFlow.Services.AdManagerService).Keys;
                _ = _p_AdManagerService_Keys; // Suppress CS0219 warning
                ...
                var _p_AudioService_Config = default(PixelFlow.Services.AudioService).Config;
                _ = _p_AudioService_Config; // Suppress CS0219 warning
                ...
                var _p_CameraController_Config = default(PixelFlow.Services.CameraController).Config;
                _ = _p_CameraController_Config; // Suppress CS0219 warning
                ...
                var _p_CameraControllerMediator_SignalBus = default(PixelFlow.Services.CameraControllerMediator).SignalBus;
                _ = _p_CameraControllerMediator_SignalBus; // Suppress CS0219 warning
                ...
                var _p_DailyCrisisService_Config = default(PixelFlow.Services.DailyCrisisService).Config;
                _ = _p_DailyCrisisService_Config; // Suppress CS0219 warning
                var _p_DailyLoginStreakService_InventoryModel = default(PixelFlow.Services.DailyLoginStreakService).InventoryModel;
                _ = _p_DailyLoginStreakService_InventoryModel; // Suppress CS0219 warning
                var _p_DailyLoginStreakService_EconomyService = default(PixelFlow.Services.DailyLoginStreakService).EconomyService;
                _ = _p_DailyLoginStreakService_EconomyService; // Suppress CS0219 warning
                var _p_DailyLoginStreakService_LoggerService = default(PixelFlow.Services.DailyLoginStreakService).LoggerService;
                _ = _p_DailyLoginStreakService_LoggerService; // Suppress CS0219 warning
                var _p_DailyLoginStreakService_PlayerPrefsService = default(PixelFlow.Services.DailyLoginStreakService).PlayerPrefsService;
                _ = _p_DailyLoginStreakService_PlayerPrefsService; // Suppress CS0219 warning
                var _p_DailyLoginStreakService_Config = default(PixelFlow.Services.DailyLoginStreakService).Config;
                _ = _p_DailyLoginStreakService_Config; // Suppress CS0219 warning
                var _p_DailyLoginStreakService_Keys = default(PixelFlow.Services.DailyLoginStreakService).Keys;
                _ = _p_DailyLoginStreakService_Keys; // Suppress CS0219 warning
                var _p_DailyLoginStreakService_EconomyConfig = default(PixelFlow.Services.DailyLoginStreakService).EconomyConfig;
                _ = _p_DailyLoginStreakService_EconomyConfig; // Suppress CS0219 warning
                var _p_DailyLoginStreakService_SkinCatalog = default(PixelFlow.Services.DailyLoginStreakService).SkinCatalog;
                _ = _p_DailyLoginStreakService_SkinCatalog; // Suppress CS0219 warning
                ...
                var _p_GridStateSerializer_StorageKeysConfig = default(PixelFlow.Services.GridStateSerializer).StorageKeysConfig;
                _ = _p_GridStateSerializer_StorageKeysConfig; // Suppress CS0219 warning
                ...
                var _p_IapIntegrationService_IapService = default(PixelFlow.Services.IapIntegrationService).IapService;
                _ = _p_IapIntegrationService_IapService; // Suppress CS0219 warning
                var _p_IapIntegrationService_EconomyService = default(PixelFlow.Services.IapIntegrationService).EconomyService;
                _ = _p_IapIntegrationService_EconomyService; // Suppress CS0219 warning
                var _p_IapIntegrationService_Logger = default(PixelFlow.Services.IapIntegrationService).Logger;
                _ = _p_IapIntegrationService_Logger; // Suppress CS0219 warning
                var _p_IapIntegrationService_FeedbackService = default(PixelFlow.Services.IapIntegrationService).FeedbackService;
                _ = _p_IapIntegrationService_FeedbackService; // Suppress CS0219 warning
                var _p_IapIntegrationService_Config = default(PixelFlow.Services.IapIntegrationService).Config;
                _ = _p_IapIntegrationService_Config; // Suppress CS0219 warning
                var _p_IapIntegrationService_Keys = default(PixelFlow.Services.IapIntegrationService).Keys;
                _ = _p_IapIntegrationService_Keys; // Suppress CS0219 warning
                ...
                var _p_LevelLoaderService_GridStateSerializer = default(PixelFlow.Services.LevelLoaderService).GridStateSerializer;
                _ = _p_LevelLoaderService_GridStateSerializer; // Suppress CS0219 warning
                var _p_LevelValidator_DifficultyFormulaConfig = default(PixelFlow.Services.LevelValidator).DifficultyFormulaConfig;
                _ = _p_LevelValidator_DifficultyFormulaConfig; // Suppress CS0219 warning
                var _p_LocalEconomyValidator_EconomyConfig = default(PixelFlow.Services.LocalEconomyValidator).EconomyConfig;
                _ = _p_LocalEconomyValidator_EconomyConfig; // Suppress CS0219 warning
                ...
                var _p_LocalizationService_Config = default(PixelFlow.Services.LocalizationService).Config;
                _ = _p_LocalizationService_Config; // Suppress CS0219 warning
                var _p_LocalizationService_LocalizationTableProvider = default(PixelFlow.Services.LocalizationService).LocalizationTableProvider;
                _ = _p_LocalizationService_LocalizationTableProvider; // Suppress CS0219 warning
                ...
                var _p_ProceduralLevelGenerator_DifficultyFormulaConfig = default(PixelFlow.Services.ProceduralLevelGenerator).DifficultyFormulaConfig;
                _ = _p_ProceduralLevelGenerator_DifficultyFormulaConfig; // Suppress CS0219 warning
                var _p_RuntimePathSolver_Config = default(PixelFlow.Services.RuntimePathSolver).Config;
                _ = _p_RuntimePathSolver_Config; // Suppress CS0219 warning
                var _p_RushHourEventService_EconomyService = default(PixelFlow.Services.RushHourEventService).EconomyService;
                _ = _p_RushHourEventService_EconomyService; // Suppress CS0219 warning
                var _p_RushHourEventService_LoggerService = default(PixelFlow.Services.RushHourEventService).LoggerService;
                _ = _p_RushHourEventService_LoggerService; // Suppress CS0219 warning
                var _p_RushHourEventService_PlayerPrefsService = default(PixelFlow.Services.RushHourEventService).PlayerPrefsService;
                _ = _p_RushHourEventService_PlayerPrefsService; // Suppress CS0219 warning
                var _p_RushHourEventService_SignalBus = default(PixelFlow.Services.RushHourEventService).SignalBus;
                _ = _p_RushHourEventService_SignalBus; // Suppress CS0219 warning
                var _p_RushHourEventService_RushHourConfig = default(PixelFlow.Services.RushHourEventService).RushHourConfig;
                _ = _p_RushHourEventService_RushHourConfig; // Suppress CS0219 warning
                var _p_RushHourEventService_Config = default(PixelFlow.Services.RushHourEventService).Config;
                _ = _p_RushHourEventService_Config; // Suppress CS0219 warning
                var _p_RushHourEventService_Keys = default(PixelFlow.Services.RushHourEventService).Keys;
                _ = _p_RushHourEventService_Keys; // Suppress CS0219 warning
                var _p_ScoreCalculator_Config = default(PixelFlow.Services.ScoreCalculator).Config;
                _ = _p_ScoreCalculator_Config; // Suppress CS0219 warning
                var _p_SkinCatalogService_LoggerService = default(PixelFlow.Services.SkinCatalogService).LoggerService;
                _ = _p_SkinCatalogService_LoggerService; // Suppress CS0219 warning
                ...
                var _p_VehicleSimulator_GridViewProvider = default(PixelFlow.Services.VehicleSimulator).GridViewProvider;
                _ = _p_VehicleSimulator_GridViewProvider; // Suppress CS0219 warning
                ...
                var _p_VehicleSimulator_DefaultSkinConfig = default(PixelFlow.Services.VehicleSimulator).DefaultSkinConfig;
                _ = _p_VehicleSimulator_DefaultSkinConfig; // Suppress CS0219 warning
                var _p_VehicleSimulator_BouncyPhysicsConfig = default(PixelFlow.Services.VehicleSimulator).BouncyPhysicsConfig;
                _ = _p_VehicleSimulator_BouncyPhysicsConfig; // Suppress CS0219 warning
                ...
                var _p_EncryptedCloudSaveAdapter_Keys = default(PixelFlow.Services.GlobalRelease.EncryptedCloudSaveAdapter).Keys;
                _ = _p_EncryptedCloudSaveAdapter_Keys; // Suppress CS0219 warning
                ...
                var _p_LocalNotificationService_Config = default(PixelFlow.Services.GlobalRelease.LocalNotificationService).Config;
                _ = _p_LocalNotificationService_Config; // Suppress CS0219 warning
                ...
                _ = _p_PrivacyComplianceService_Config; // Suppress CS0219 warning
                var _p_SilentCrashDiagnosticsService_LoggerService = default(PixelFlow.Services.GlobalRelease.SilentCrashDiagnosticsService).LoggerService;
                _ = _p_SilentCrashDiagnosticsService_LoggerService; // Suppress CS0219 warning
                var _p_SilentCrashDiagnosticsService_Config = default(PixelFlow.Services.GlobalRelease.SilentCrashDiagnosticsService).Config;
                _ = _p_SilentCrashDiagnosticsService_Config; // Suppress CS0219 warning
                var _p_CloudSaveManager_Adapter = default(PixelFlow.Models.CloudSaveManager).Adapter;
                _ = _p_CloudSaveManager_Adapter; // Suppress CS0219 warning
                var _p_CloudSaveManager_Prefs = default(PixelFlow.Models.CloudSaveManager).Prefs;
                _ = _p_CloudSaveManager_Prefs; // Suppress CS0219 warning
                var _p_CloudSaveManager_LoggerService = default(PixelFlow.Models.CloudSaveManager).LoggerService;
                _ = _p_CloudSaveManager_LoggerService; // Suppress CS0219 warning
                var _p_CloudSaveManager_Keys = default(PixelFlow.Models.CloudSaveManager).Keys;
                _ = _p_CloudSaveManager_Keys; // Suppress CS0219 warning
                var _p_DailyCrisisModel_Config = default(PixelFlow.Models.DailyCrisisModel).Config;
                _ = _p_DailyCrisisModel_Config; // Suppress CS0219 warning
                var _p_GameSessionModel_Logger = default(PixelFlow.Models.GameSessionModel).Logger;
                _ = _p_GameSessionModel_Logger; // Suppress CS0219 warning
                var _p_HintModel_Config = default(PixelFlow.Models.HintModel).Config;
                _ = _p_HintModel_Config; // Suppress CS0219 warning
                ...
                var _p_InventoryModel_Config = default(PixelFlow.Models.InventoryModel).Config;
                _ = _p_InventoryModel_Config; // Suppress CS0219 warning
                ...
                var _p_CheckWinConditionCommand_ScoreCalculator = default(PixelFlow.Commands.CheckWinConditionCommand).ScoreCalculator;
                _ = _p_CheckWinConditionCommand_ScoreCalculator; // Suppress CS0219 warning
                ...
                var _p_ClearJamCommand_Config = default(PixelFlow.Commands.ClearJamCommand).Config;
                _ = _p_ClearJamCommand_Config; // Suppress CS0219 warning
                ...
                var _p_PlaceViaductCommand_Config = default(PixelFlow.Commands.PlaceViaductCommand).Config;
                _ = _p_PlaceViaductCommand_Config; // Suppress CS0219 warning
                ...
                var _p_ProcessInputCommand_GridStateSerializer = default(PixelFlow.Commands.ProcessInputCommand).GridStateSerializer;
                _ = _p_ProcessInputCommand_GridStateSerializer; // Suppress CS0219 warning
                ...
                var _p_ProcessInputCommand_Config = default(PixelFlow.Commands.ProcessInputCommand).Config;
                _ = _p_ProcessInputCommand_Config; // Suppress CS0219 warning
                ...
                var _p_UseHintCommand_Config = default(PixelFlow.Commands.UseHintCommand).Config;
                _ = _p_UseHintCommand_Config; // Suppress CS0219 warning
                ...
                var _p_SaveProgressCommand_InventoryModel = default(PixelFlow.Commands.SaveProgressCommand).InventoryModel;
                _ = _p_SaveProgressCommand_InventoryModel; // Suppress CS0219 warning
                var _p_SaveProgressCommand_RushHourEventService = default(PixelFlow.Commands.SaveProgressCommand).RushHourEventService;
                _ = _p_SaveProgressCommand_RushHourEventService; // Suppress CS0219 warning
                ...
                var _p_SaveProgressCommand_Keys = default(PixelFlow.Commands.SaveProgressCommand).Keys;
                _ = _p_SaveProgressCommand_Keys; // Suppress CS0219 warning
                var _p_SaveProgressCommand_GridStateSerializer = default(PixelFlow.Commands.SaveProgressCommand).GridStateSerializer;
                _ = _p_SaveProgressCommand_GridStateSerializer; // Suppress CS0219 warning
                ...
                var _p_RewardedAdCommand_Logger = default(PixelFlow.Commands.RewardedAdCommand).Logger;
                _ = _p_RewardedAdCommand_Logger; // Suppress CS0219 warning
                var _p_RewardedAdCommand_FeedbackService = default(PixelFlow.Commands.RewardedAdCommand).FeedbackService;
                _ = _p_RewardedAdCommand_FeedbackService; // Suppress CS0219 warning
                var _p_SkinUnlockCommand_InventoryModel = default(PixelFlow.Commands.SkinUnlockCommand).InventoryModel;
                _ = _p_SkinUnlockCommand_InventoryModel; // Suppress CS0219 warning
                var _p_SkinUnlockCommand_EconomyService = default(PixelFlow.Commands.SkinUnlockCommand).EconomyService;
                _ = _p_SkinUnlockCommand_EconomyService; // Suppress CS0219 warning
                var _p_SkinUnlockCommand_Logger = default(PixelFlow.Commands.SkinUnlockCommand).Logger;
                _ = _p_SkinUnlockCommand_Logger; // Suppress CS0219 warning
                var _p_SkinUnlockCommand_FeedbackService = default(PixelFlow.Commands.SkinUnlockCommand).FeedbackService;
                _ = _p_SkinUnlockCommand_FeedbackService; // Suppress CS0219 warning
                var _p_SkinUnlockCommand_Config = default(PixelFlow.Commands.SkinUnlockCommand).Config;
                _ = _p_SkinUnlockCommand_Config; // Suppress CS0219 warning
                var _p_SkinUnlockCommand_SkinCatalog = default(PixelFlow.Commands.SkinUnlockCommand).SkinCatalog;
                _ = _p_SkinUnlockCommand_SkinCatalog; // Suppress CS0219 warning
                var _p_SkinUnlockCommand_Keys = default(PixelFlow.Commands.SkinUnlockCommand).Keys;
                _ = _p_SkinUnlockCommand_Keys; // Suppress CS0219 warning
                var _p_StopSkinUnlockCommand_InventoryModel = default(PixelFlow.Commands.StopSkinUnlockCommand).InventoryModel;
                _ = _p_StopSkinUnlockCommand_InventoryModel; // Suppress CS0219 warning
                var _p_StopSkinUnlockCommand_EconomyService = default(PixelFlow.Commands.StopSkinUnlockCommand).EconomyService;
                _ = _p_StopSkinUnlockCommand_EconomyService; // Suppress CS0219 warning
                var _p_StopSkinUnlockCommand_Logger = default(PixelFlow.Commands.StopSkinUnlockCommand).Logger;
                _ = _p_StopSkinUnlockCommand_Logger; // Suppress CS0219 warning
                var _p_StopSkinUnlockCommand_FeedbackService = default(PixelFlow.Commands.StopSkinUnlockCommand).FeedbackService;
                _ = _p_StopSkinUnlockCommand_FeedbackService; // Suppress CS0219 warning
                var _p_StopSkinUnlockCommand_Config = default(PixelFlow.Commands.StopSkinUnlockCommand).Config;
                _ = _p_StopSkinUnlockCommand_Config; // Suppress CS0219 warning
                var _p_StopSkinUnlockCommand_SkinCatalog = default(PixelFlow.Commands.StopSkinUnlockCommand).SkinCatalog;
                _ = _p_StopSkinUnlockCommand_SkinCatalog; // Suppress CS0219 warning
                var _p_StopSkinUnlockCommand_Keys = default(PixelFlow.Commands.StopSkinUnlockCommand).Keys;
                _ = _p_StopSkinUnlockCommand_Keys; // Suppress CS0219 warning
                var _p_ChangeAudioVolumeCommand_SettingsModel = default(PixelFlow.Commands.ChangeAudioVolumeCommand).SettingsModel;
                _ = _p_ChangeAudioVolumeCommand_SettingsModel; // Suppress CS0219 warning
                var _p_ChangeAudioVolumeCommand_LoggerService = default(PixelFlow.Commands.ChangeAudioVolumeCommand).LoggerService;
                _ = _p_ChangeAudioVolumeCommand_LoggerService; // Suppress CS0219 warning
                var _p_ChangeColorBlindModeCommand_SettingsModel = default(PixelFlow.Commands.ChangeColorBlindModeCommand).SettingsModel;
                _ = _p_ChangeColorBlindModeCommand_SettingsModel; // Suppress CS0219 warning
                var _p_ChangeColorBlindModeCommand_LoggerService = default(PixelFlow.Commands.ChangeColorBlindModeCommand).LoggerService;
                _ = _p_ChangeColorBlindModeCommand_LoggerService; // Suppress CS0219 warning
                ...
                var _p_ToggleHapticsCommand_SettingsModel = default(PixelFlow.Commands.ToggleHapticsCommand).SettingsModel;
                _ = _p_ToggleHapticsCommand_SettingsModel; // Suppress CS0219 warning
                var _p_ToggleHapticsCommand_LoggerService = default(PixelFlow.Commands.ToggleHapticsCommand).LoggerService;
                _ = _p_ToggleHapticsCommand_LoggerService; // Suppress CS0219 warning
            }
